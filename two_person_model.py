...
# Initialize models
sep_model = separator.from_hparams(source="speechbrain/sepformer-whamr16k", savedir='pretrained_models/sepformer-whamr16k')
...
def separate_sources(input_audio_path):
    ...
    for idx in range(est_sources.shape[2]):
        ...
        torchaudio.save(output_path, est_sources[:, :, idx].detach().cpu(), 16000)
